// internal/tui/shared/shared.go
// Package shared contains styles, colors, and icons shared across all TUI panels.
// It exists as a separate package to break the import cycle between the root tui
// package (which contains the app model) and the panel sub-packages.
package shared
